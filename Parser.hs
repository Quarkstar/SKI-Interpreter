...
happyExpList = Happy_Data_Array.listArray (0,19) ([256,4,60,1025,16400,0,3072,48,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Exp","add","sub","mul","div","const","%eof"]
...
happyReduction_1 (HappyTerminal (CONST happy_var_1))
	 =  HappyAbsSyn4
		 (EConst happy_var_1
	)
